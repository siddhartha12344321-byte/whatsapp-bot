...
// (Basic load/save logic to save space - add your encryption if needed, this keeps it simple for stability)
...
// --- 7. WHATSAPP CLIENT (STABILITY FIX) ---
const client = new Client({
    authStrategy: new LocalAuth(),
    puppeteer: {
        headless: true, // Standard Boolean
        args: [
            '--no-sandbox', // CRITICAL FOR LINUX/RENDER
            '--disable-setuid-sandbox',
            '--disable-dev-shm-usage', // PREVENTS MEMORY CRASH
